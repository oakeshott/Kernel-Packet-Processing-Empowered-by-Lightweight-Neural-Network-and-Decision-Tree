...
const int layer_1_s_w_inv[16] = {24, 19, 1, 7, 9, 10, 28, 15, 7, 9, 9, 12, 1, 17, 8, 9};

const int layer_2_s_x = 2336756;

const int layer_2_s_x_inv = 1838;

const int layer_2_s_w_inv[16] = {29, 25, 47, 18, 64, 44, 55, 30, 24, 26, 67, 28, 22, 95, 26, 61};

const int layer_3_s_x = 1056437;

const int layer_3_s_x_inv = 4066;

const int layer_3_s_w_inv[2] = {157, 153};
