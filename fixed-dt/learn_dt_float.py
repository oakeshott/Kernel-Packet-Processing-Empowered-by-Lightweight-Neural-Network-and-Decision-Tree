...
def get_logdir(fold, n_fold, max_depth, is_binary):
        return os.path.join(os.path.join('runs', 'dt/binary-classification'), 'float-maxdepth' + str(max_depth))
    else:
        return os.path.join(os.path.join('runs', 'dt/multi-classification'), 'float-maxdepth' + str(max_depth))
